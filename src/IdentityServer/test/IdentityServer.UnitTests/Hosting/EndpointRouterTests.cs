...
namespace IdentityServer.UnitTests.Hosting
{
    ...
    {
        private Dictionary<string, Meniga.IdentityServer.Hosting.Endpoint> _pathMap;
        private List<Meniga.IdentityServer.Hosting.Endpoint> _endpoints;
        private IdentityServerOptions _options;
        private EndpointRouter _subject;

        public EndpointRouterTests()
        {
            _pathMap = new Dictionary<string, Meniga.IdentityServer.Hosting.Endpoint>();
            _endpoints = new List<Meniga.IdentityServer.Hosting.Endpoint>();
        ...
        {
            Action a = () => new Meniga.IdentityServer.Hosting.Endpoint("ep1", "ep1", typeof(MyEndpointHandler));
        ...
        {
            _endpoints.Add(new Meniga.IdentityServer.Hosting.Endpoint("ep1", "/ep1", typeof(MyEndpointHandler)));
            _endpoints.Add(new Meniga.IdentityServer.Hosting.Endpoint("ep2", "/ep2", typeof(MyOtherEndpointHandler)));
        ...
        {
            _endpoints.Add(new Meniga.IdentityServer.Hosting.Endpoint("ep1", "/ep1", typeof(MyEndpointHandler)));
            _endpoints.Add(new Meniga.IdentityServer.Hosting.Endpoint("ep1", "/ep1", typeof(MyOtherEndpointHandler)));
        ...
        {
            _endpoints.Add(new Meniga.IdentityServer.Hosting.Endpoint(EndpointNames.Authorize, "/ep1", typeof(MyEndpointHandler)));
            _endpoints.Add(new Meniga.IdentityServer.Hosting.Endpoint("ep2", "/ep2", typeof(MyOtherEndpointHandler)));
