...
namespace IdentityServer.UnitTests.ResponseHandling.AuthorizeInteractionResponseGenerator
{
    public class AuthorizeInteractionResponseGeneratorTests
    {
        ...
        private Meniga.IdentityServer.ResponseHandling.AuthorizeInteractionResponseGenerator _subject;
        ...
        {
            _subject = new Meniga.IdentityServer.ResponseHandling.AuthorizeInteractionResponseGenerator(
                _clock,
