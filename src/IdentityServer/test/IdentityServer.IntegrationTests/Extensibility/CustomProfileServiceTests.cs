...
namespace IdentityServer.IntegrationTests.Extensibility
{
    public class CustomProfileServiceTests
    {
        ...
        public CustomProfileServiceTests()
        {
            ...
            _mockPipeline.Users.Add(new Meniga.IdentityServer.Test.TestUser
            {
                SubjectId = "bob",
                Username = "bob",
                Password = "password",
        ...
        public async Task custom_profile_should_return_claims_for_implicit_client()
        {
            ...
            var authorization = new Meniga.IdentityModel.Client.AuthorizeResponse(response.Headers.Location.ToString());
