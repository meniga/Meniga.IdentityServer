...
using Meniga.IdentityServer.Configuration.DependencyInjection;
using Meniga.IdentityServer.Endpoints;
...
using Meniga.IdentityServer.Hosting.FederatedSignOut;
using Meniga.IdentityServer.Services.Default;
...
public static class IdentityServerBuilderExtensionsCore
{
        ...
        where T : class, IEndpointHandler
    {
        ...
        builder.Services.AddSingleton(new Meniga.IdentityServer.Hosting.Endpoint(name, path, typeof(T)));
