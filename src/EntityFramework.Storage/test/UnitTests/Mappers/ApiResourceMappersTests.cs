...
using Xunit;
using ApiResource = Meniga.IdentityServer.Models.ApiResource;

namespace Meniga.IdentityServer.EntityFramework.UnitTests.Mappers
{
    public class ApiResourceMappersTests
    {
        ...
        {
            var entity = new Meniga.IdentityServer.EntityFramework.Entities.ApiResource
            {
